...
class TestFakerTime < Test::Unit::TestCase
  ...
  def test_between_with_time_parameters
    ...
    deterministically_verify -> { @tester.between(from: from, to: to) } do |random_time|
  ...
  def test_forward
    ...
    deterministically_verify -> { @tester.forward(days: 10) } do |random_time|
  ...
  def test_backward
    ...
    deterministically_verify -> { @tester.backward(days: 10) } do |random_time|
